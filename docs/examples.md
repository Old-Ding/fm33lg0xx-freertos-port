...
- 观察变量：`g_ledTaskCreateStatus`、`g_ledTaskLoopCount`、`g_ledTaskStackHighWaterMark`、`g_freertosFaultCode`、`g_freertosHeapFreeBytes`、`g_freertosHeapMinimumEverFreeBytes`、`g_stackOverflowTaskHandle`、`g_stackOverflowTaskName`、`g_freertosAssertFile`、`g_freertosAssertLine`。
